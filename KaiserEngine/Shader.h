...
public:
    ...
    void LoadUniformMatrix(const GLint& location, const MatrixMath::MatrixQ<double, 2>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::MatrixQ<double, 3>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::MatrixQ<double, 4>& matrix) const;
    ...
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 2, 3>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 3, 2>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 2, 4>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 4, 2>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 3, 4>& matrix) const;
    void LoadUniformMatrix(const GLint& location, const MatrixMath::Matrix<double, 4, 3>& matrix) const;
};
